...
public class BookController {
    ...
    @Operation(summary = "Find by isbn13")
    @GetMapping("{isbn13}")
    public BookResponseDTO findById(final @PathVariable String isbn13) {
        return toBookResponseDTO(bookService.findByIsbn13(isbn13));
    }
